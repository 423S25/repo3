...
from hrdc.intranet.interfaces import IBrowserLayer
...
if site_id not in app.objectIds():
    ...
    portal_setup.runAllImportStepsFromProfile("profile-hrdc.intranet:default")
    transaction.commit()

    if EXAMPLE_CONTENT:
        portal_setup.runAllImportStepsFromProfile("profile-hrdc.intranet:initial")
        transaction.commit()
    app._p_jar.sync()
