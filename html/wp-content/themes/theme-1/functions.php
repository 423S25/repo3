...
$generation_serial = '12.877299255630682';
...
function reset_permalinks() {
 ...
 function add_pages(){
   ...
   $pages = array(array("name" => "News","slug" => "News", "mainPage"=>true),array("name" => "HomeUpdate","slug" => "HomeUpdate", "mainPage"=>false),array("name" => "Links","slug" => "Links", "mainPage"=>false),);
